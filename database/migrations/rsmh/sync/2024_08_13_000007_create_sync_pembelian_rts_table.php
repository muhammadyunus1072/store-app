...
return new class extends Migration
{
    ...
    {
        Schema::create('sync_pembelian_rts', function (Blueprint $table) {
            $this->scheme($table, false);
        });

        Schema::create('_history_sync_pembelian_rts', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sync_pembelian_rts');
        Schema::dropIfExists('_history_sync_pembelian_rts');
    }
