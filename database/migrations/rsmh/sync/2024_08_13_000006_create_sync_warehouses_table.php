...
return new class extends Migration
{
    ...
    {
        Schema::create('sync_warehouses', function (Blueprint $table) {
            $this->scheme($table, false);
        });

        Schema::create('_history_sync_warehouses', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sync_warehouses');
        Schema::dropIfExists('_history_sync_warehouses');
    }
