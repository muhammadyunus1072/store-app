...
class Datatable extends Component
{
    ...
    public function onDialogDeleteConfirm()
    {
        ...
        CategorySupplierRepository::delete(Crypt::decrypt($this->targetDeleteId));
        ...
        return [
            [
                ...
                'render' => function ($item) {
                    ...
                    if ($this->isCanUpdate) {
                        $editUrl = route('category_supplier.edit', $id);
    ...
    {
        return CategorySupplierRepository::datatable();
    }

    public function getView(): string
    {
        return 'livewire.purchasing.master.category-supplier.datatable';
    }
}
