...
class Datatable extends Component
{
    ...
    */
    ...
    {
        return StockRequestInRepository::datatable(
            $this->search,
            $this->dateStart,
            $this->dateEnd,
    ...
    {
        return 'livewire.logistic.report.warehouse.stock-request-in.datatable';
    }
    ...
    */
    ...
    {
        return 'Laporan Permintaan Masuk Gudang ' . Carbon::parse($this->dateStart)->format('Y-m-d') . ' sd ' . Carbon::parse($this->dateEnd)->format('Y-m-d');
    }

    function datatableExportTitle(): string
    {
        return 'Laporan Permintaan Masuk Gudang';
    }
