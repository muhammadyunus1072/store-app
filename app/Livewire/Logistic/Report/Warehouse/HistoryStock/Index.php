...
namespace App\Livewire\Logistic\Report\Warehouse\HistoryStock;
...
use App\Repositories\Logistic\Report\Warehouse\HistoryStock\HistoryStockRepository;
...
class Index extends Component
{
    ...
    {
        return view('livewire.logistic.report.warehouse.history-stock.index');
    }
    ...
    public function getData()
    {
        ...
        // START INFO
        $startInfo = HistoryStockRepository::getStartInfo($productId, Carbon::parse($this->dateStart)->subDay()->format("Y-m-d"), $warehouseId);
        $this->startQuantity = $startInfo ? $startInfo->quantity : 0;
        $this->startValue = $startInfo ? $startInfo->value : 0;

        // HISTORIES
        $histories = HistoryStockRepository::getHistories($productId, $this->dateStart, $this->dateEnd, $warehouseId);
    ...
    public function export($type)
    {
        return ExportHelper::export(
            ...
            view: 'app.logistic.report.warehouse.history-stock.export',
            data: [
