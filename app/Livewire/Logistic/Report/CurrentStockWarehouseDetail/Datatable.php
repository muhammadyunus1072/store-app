...
namespace App\Livewire\Logistic\Report\CurrentStockWarehouseDetail;
...
use App\Repositories\Logistic\Report\CurrentStockWarehouseDetail\CurrentStockWarehouseDetailRepository;
...
class Datatable extends Component
{
    ...
    public function export($type)
    {
        ...
        return ExportHelper::export(
            ...
            $fileName,
            $data,
            "app.logistic.report.current-stock-warehouse-detail.export",
            [
    ...
    {
        return CurrentStockWarehouseDetailRepository::datatable($this->search, $this->date_start, $this->date_end, $this->products, $this->category_products, $this->warehouseId ? Crypt::decrypt($this->warehouseId) : null);
    }
    ...
    {
        $this->setHeader();
        return 'livewire.logistic.report.current-stock-warehouse-detail.datatable';
    }
}
