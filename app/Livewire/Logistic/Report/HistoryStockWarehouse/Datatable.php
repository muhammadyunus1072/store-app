...
class Datatable extends Component
{
    ...
    public function export($type)
    {
        ...
        return ExportHelper::export(
            ...
            $fileName,
            $data,
            "app.logistic.report.history-stock-warehouse.export",
            [
    ...
    {
        return HistoryStockWarehouseRepository::datatable($this->search, $this->date_start, $this->date_end, $this->products, $this->category_products, $this->warehouseId ? Crypt::decrypt($this->warehouseId) : null);
    }

    public function getView(): string
    {
        return 'livewire.logistic.report.history-stock-warehouse.datatable';
    }
}
