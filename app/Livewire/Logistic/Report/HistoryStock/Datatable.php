...
class Datatable extends Component
{
    ...
    public function export($type)
    {
        ...
        return ExportHelper::export(
            ...
            $fileName,
            $data,
            "app.logistic.report.history-stock.export",
            [
    ...
    {
        return HistoryStockRepository::datatable($this->search, $this->date_start, $this->date_end, $this->products, $this->category_products);
    }

    public function getView(): string
    {
        return 'livewire.logistic.report.history-stock.datatable';
    }
}
