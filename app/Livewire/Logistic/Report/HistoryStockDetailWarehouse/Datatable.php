...
class Datatable extends Component
{
    ...
    {
        $fileName = 'Data Kartu Stok Detail Gudang ' . Carbon::parse($this->date_start)->format('Y-m-d') . ' sd ' . Carbon::parse($this->date_end)->format('Y-m-d');
        $colspan = 0;
        ...
        return ExportHelper::export(
            ...
            $fileName,
            $data,
            "app.logistic.report.history-stock-detail-warehouse.export",
            [
                ...
                'keyword' => $this->search,
                'type' => $type,
                'title' => 'Data Kartu Stok Detail Gudang',
            ],
            [
                'size' => 'legal',
    ...
    {
        return HistoryStockDetailWarehouseRepository::datatable($this->search, $this->date_start, $this->date_end, $this->products, $this->category_products, $this->warehouseId ? Crypt::decrypt($this->warehouseId) : null);
    }

    public function getView(): string
    {
        return 'livewire.logistic.report.history-stock-detail-warehouse.datatable';
    }
}
