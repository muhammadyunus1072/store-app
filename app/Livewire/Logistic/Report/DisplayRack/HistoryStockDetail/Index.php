...
namespace App\Livewire\Logistic\Report\Warehouse\HistoryStockDetail;
...
use App\Repositories\Logistic\Report\Warehouse\HistoryStockDetail\HistoryStockDetailRepository;
...
class Index extends Component
{
    ...
    {
        return view('livewire.logistic.report.warehouse.history-stock-detail.index');
    }
    ...
    public function getData()
    {
        ...
        // START INFO
        $startData = HistoryStockDetailRepository::getStartInfo($productId, Carbon::parse($this->dateStart)->subDay()->format("Y-m-d"), $warehouseId);

        // HISTORIES
        $histories = HistoryStockDetailRepository::getHistories($productId, $this->dateStart, $this->dateEnd, $warehouseId);
    ...
    public function export($type)
    {
        return ExportHelper::export(
            ...
            view: 'app.logistic.report.warehouse.history-stock-detail.export',
            data: [
                'data' => $this->data,
