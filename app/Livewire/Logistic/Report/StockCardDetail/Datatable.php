...
namespace App\Livewire\Logistic\Report\StockCardDetail;
...
class Datatable extends Component
{
    ...
    public function export($type)
    {
        ...
        return ExportHelper::export(
            ...
            $fileName,
            $data,
            "app.logistic.report.stock-card-detail.export",
            [
    ...
    {
        return 'livewire.logistic.report.stock-card-detail.datatable';
    }
}
