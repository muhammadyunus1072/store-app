...
class Datatable extends Component
{
    ...
    public function onMount()
    {
        ...
        $this->isCanUpdate = $authUser->hasPermissionTo(PermissionHelper::transform(PermissionHelper::ACCESS_STOCK_EXPENSE, PermissionHelper::TYPE_UPDATE));
        $this->isCanDelete = $authUser->hasPermissionTo(PermissionHelper::transform(PermissionHelper::ACCESS_STOCK_EXPENSE, PermissionHelper::TYPE_DELETE));
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            [
                ...
                'render' => function($item)
                {
                    return Carbon::parse($item->expense_date)->translatedFormat('d F Y');
                }
            ],
            [
                'key' => 'note',
