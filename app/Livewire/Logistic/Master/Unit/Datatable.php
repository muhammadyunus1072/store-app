...
class Datatable extends Component
{
    ...
    public function onMount()
    {
        ...
        $this->isCanUpdate = $authUser->hasPermissionTo(PermissionHelper::transform(AccessLogistic::UNIT, PermissionHelper::TYPE_UPDATE));
        $this->isCanDelete = $authUser->hasPermissionTo(PermissionHelper::transform(AccessLogistic::UNIT, PermissionHelper::TYPE_DELETE));
    }
