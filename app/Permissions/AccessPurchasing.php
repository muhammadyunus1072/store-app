...
class AccessPurchasing
{
    ...
    // const I_PURCHASE_ORDER = "i_purchase_order";
    ...
    const TYPE_ALL = [
        ...
        // self::I_PURCHASE_ORDER => [PermissionHelper::TYPE_READ, PermissionHelper::TYPE_DELETE],
    ...
    const TRANSLATE = [
        ...
        // self::I_PURCHASE_ORDER => "Import Data - Pembelian",
