...
namespace App\Repositories\Logistic\Report\Warehouse\StockRequestOut;

use App\Models\Logistic\Transaction\StockRequest\StockRequestProduct;

class StockRequestOutRepository
{
    public static function datatable(
        ...
        return StockRequestProduct::select(
            ...
            ->where('stock_requests.destination_warehouse_id', '=', $warehouseId)
            ...
            ->when($warehouseIds, function ($query) use ($warehouseIds) {
                $query->whereIn('stock_request_products.source_warehouse_id', $warehouseIds);
            })
