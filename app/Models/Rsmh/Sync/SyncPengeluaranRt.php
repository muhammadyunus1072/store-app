...
use App\Jobs\Rsmh\Sync\SyncPengeluaranRTJob;
use Sis\TrackHistory\HasTrackHistory;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\SoftDeletes;
use Illuminate\Database\Eloquent\Factories\HasFactory;

class SyncPengeluaranRt extends Model
{
    ...
    public function dispatchJob()
    {
        ...
        for ($offset = 0; $offset < $this->total; $offset += $limit) {
            ...
            SyncPengeluaranRTJob::dispatch($this->id, $this->source_warehouse_id, $jobLimit, $offset);
        }
    }
